...
CREATE TABLE `answers` (
  ...
  CONSTRAINT `answers_ibfk_3` FOREIGN KEY (`inspectionReportId`) REFERENCES `inspection_reports` (`id`) ON DELETE CASCADE ON UPDATE CASCADE,
  CONSTRAINT `answers_ibfk_4` FOREIGN KEY (`questionId`) REFERENCES `questions` (`id`) ON DELETE NO ACTION ON UPDATE CASCADE
...
CREATE TABLE `inspection_reports` (
  ...
  CONSTRAINT `inspection_reports_ibfk_3` FOREIGN KEY (`formTemplateId`) REFERENCES `form_templates` (`id`) ON DELETE NO ACTION ON UPDATE CASCADE,
  CONSTRAINT `inspection_reports_ibfk_4` FOREIGN KEY (`companyId`) REFERENCES `companies` (`id`) ON DELETE NO ACTION ON UPDATE CASCADE
...
-- Dump completed on 2026-06-22  9:37:25
